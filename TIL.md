...
챌린지를 잘 진행해 오다가 졸업 과제 작성 후, 프로젝트를 배포하는 과정에서 막혀 챌린지를 포기하는 경우가 더러 있습니다. 뒤로 미루지 말고 미리미리 배포 단계를 진행해보세요!
배포 과정에서는 생각보다 많은 일들을 수행해야 합니다.
백엔드/프론트엔드 구축
MongoDB Atlas
환경변수 설정
Github 설정
AWS S3
Heroku 배포
배포 과정 중 막히는 부분은 강의 Comments, Issues, 그리고 슬랙을 이용하면 충분히 해결할 수 있습니다!
여기까지 오신 모든 챌린저 여러분, 끝까지 힘내세요!
#######################################################
